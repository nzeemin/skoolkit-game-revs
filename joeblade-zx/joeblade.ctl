...
B $8203,1,1 room number; initial = 3
B $8206,1,1 counter
...
b $8BEA
c $8C00
C $8C44,3 Draw back sprite 32x32; DE = back sprite, HL = dest
s $8C58
c $8C5A Draw back sprite 32x32
N $8C5A DE = back sprite addr, HL = destination addr
c $8C78 Copy shadow screen to real screen
b $8CDF
c $8CF0
C $8D30,3 Draw back sprite 32x32; DE = back sprite, HL = dest
c $8D3C
b $8D64
B $8D64,10,1
